...
public class ParserUtilTest {
    ...
    private static final String VALID_NOTE = "Rachel is allergic to peanuts";
    ...
    @Test
    public void parseNote_validValueWithoutWhitespace_returnsAddress() throws Exception {
        Note expectedNote = new Note(VALID_NOTE);
        assertEquals(expectedNote, ParserUtil.parseNote(VALID_NOTE));
    }

    @Test
    public void parseNote_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
