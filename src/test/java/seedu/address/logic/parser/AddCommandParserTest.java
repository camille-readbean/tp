...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + NOTE_DESC_BOB, new AddCommand(expectedClient));
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedClientString = NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + NOTE_DESC_BOB;
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        String missingAllFields = "Missing fields: name, phone, email, address, note\n" + AddCommand.MESSAGE_USAGE;
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB
                + VALID_NOTE_BOB, String.format(MESSAGE_INVALID_COMMAND_FORMAT, missingAllFields));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_TAG_DESC + VALID_TAG_FRIEND + NOTE_DESC_BOB, Tag.MESSAGE_CONSTRAINTS);
