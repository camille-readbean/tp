...
public class TypicalClients {
    ...
    public static final Client BENSON = new ClientBuilder().withName("Benson Meier")
            ...
            .withNote("Allergic to shellfish").build()
            .withNewAppointment(
